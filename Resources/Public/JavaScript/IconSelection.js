...
class IconSelection {
  ...
  onModalLoaded() {
    ...
    $(this.currentModal).find('ul.nav li a').on('click', this.onNavTabClick.bind(this));
  ...
  onNavTabClick(e) {
    ...
    $(this.currentModal).find('.nav li, .nav li a').removeClass('active');
    $(this.currentModal).find('.nav a[href="#' + tabName + '"]').addClass('active').parent().addClass('active');

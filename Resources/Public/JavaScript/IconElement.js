...
var on_click = (e, onButtonClick) => onButtonClick(e);
var root = add_locations(template(`<div><input type="hidden"> <button class="btn btn-default"><!> </button></div>`), IconElement[FILENAME], [[20, 0, [[21, 4], [22, 4]]]]);
function IconElement($$anchor, $$props) {
  check_target(new.target);
  push($$props, true, IconElement);
  ...
  onMount(() => {
    ...
    console.log("IconElement component mounted");
  });
  ...
  html(node, () => $iconStore()["actions-search"], false, false);
...
delegate(["click"]);
customElements.define("bw-icon-element", create_custom_element(
  IconElement,
  {
    itemFormElName: {},
    itemFormElValue: {},
